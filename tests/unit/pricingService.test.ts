...
describe("calculatePricing", () => {
  ...
  it("clamps principal to zero when down payment exceeds system price", () => {
    const r = calculatePricing(5, 99999, 6.9, [10], "A");
